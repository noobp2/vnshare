...
class SpreadDataEngine:
    ...
    def process_position_event(self, event: Event) -> None:
        ...
        for spread in self.symbol_spread_map[position.vt_symbol]:
            ...
            ####xtt####
            sprd_pre_pos = spread.net_pos
            spread.calculate_pos()
            sprd_cur_pos = spread.net_pos
            if not (sprd_cur_pos == sprd_pre_pos):
...
class SpreadAlgoEngine:
    ...
    def __init__(self, spread_engine: SpreadEngine):
        ...
        ####xtt####
        self.spread_algo_map: Dict[str: SpreadAlgoTemplate] = defaultdict(list)
        ####xtt####
    ...
    def process_spread_event(self, event: Event):
        ...
        ####xtt####
        algos = self.spread_algo_map.get(spread.name, None)
        if not algos:
            return
    ...
    def start_algo(
        ...
        ####xtt####
        # Generate map between spread_name and algo
        self.spread_algo_map[spread_name].append(algo)
        ####xtt####
